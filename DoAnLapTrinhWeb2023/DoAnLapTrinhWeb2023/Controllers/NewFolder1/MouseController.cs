...
namespace DoAnLapTrinhWeb2023.Controllers
{
    ...
    {
        // GET: Mouse  BanHangOnlineEntities objBanHangOnlineEntities = new BanHangOnlineEntities();
        ...
        public ActionResult Index(string tenTH)
        {
            ...
            var objKB = objBanHangOnlineEntities.sanPhams.Where(n => n.loaiSP.loaiSP1.Equals("Chuột") && (string.IsNullOrEmpty(tenTH) || (n.Brand.tenTH.Equals(tenTH)))).ToList<sanPham>();
            ViewData["MS"] = objKB;
